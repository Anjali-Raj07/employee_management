...
function view_Employee(id) {
    fetch(`http://localhost:3000/employees/${id}`, {
        ...
        .then((data) => {
            ...
            let res_address = `${data.address} ${data.city} ${data.state}  ${data.country}  ${data.pin}`;

            document.getElementById("view_image").src=`http://localhost:3000/employees/${id}/avatar`

            document.getElementById("viewName").innerHTML = name;
            document.getElementById("viewEmail").innerHTML = data.email;
            document.getElementById("viewMobilenum").innerHTML = data.phone;
            ...
            document.getElementById("viewAddress").innerHTML = res_address;
...
let viewEdit = document.getElementById("view_edit")
...
function edit_Employee(empid) {
    ...
    const edit_employeeBtn = document.getElementById("updateEmployeee");
    edit_employeeBtn.addEventListener('click', () => {
